...
public class UpdateUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (checkValidate(request, response, username, email, address, phoneNumber, dateOfBirth)) {
            ...
            String result = UserService.getInstance().updateProfileNoImage(admin.getId(), username, email, address, phoneNumber, myBirthDay, gender);
