                ...
                <div class="cart-list">
                    <table class="table">
                        ...
                        <tr class="text-center">
                            ...
                            <td class="image-prod">
                                <div  class="img" style="background-image:url(/static/images/chuoi_cau.png);width: 100px;height: 100px;"></div>
                            </td>

                            <td class="product-name">
                                <h3>Chuối Cau</h3>
                                <p>Chuối cau  có quả nhỏ, hướng tròn, mập giống hình quả cau. Một cây chuối cau có khả năng cho ra rất nhiều quả, năng suất cao nên bà con nông dân ở miền Trung và miền Nam hoặc khu vực có đồi núi ưa trồng.</p>
                            </td>
                        ...
                        <tr class="text-center">
                            ...
                            <td class="image-prod">
                                <div  class="img" style="background-image:url(/static/images/oi.jpg);width: 100px;height: 100px;"></div>
                            </td>

                            <td class="product-name">
                                <h3>Ổi</h3>
                                <p>Quả chín có vị chua ngọt hay ngọt và có mùi thơm đặc trưng, có thể ăn tươi, làm mứt hay làm nước giải khát.</p>
                            </td>
