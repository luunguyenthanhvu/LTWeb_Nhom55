...
<div style="display:none;" id="myDiv" class="animate-bottom">
    ...
    <section class="home-section">
        ...
        <div class="find-product">
            <form action="${pageContext.request.contextPath}/admin/user/list-controller?index=1" method="post">
                    ...
                    <c:forEach items="${listSearch}" var="user">
                        <tr>
                            ...
                            <td class="function-product">
                                <a href="${pageContext.request.contextPath}/admin/user/update-user?id=${user.getId()}">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/user/delete-user?id=${user.getId()}">
...
<%--                    Trường hợp tìm ra số sản phẩm chỉ có trong 1 trang thì 2 nút <,> ko được xài&ndash;%&gt;--%>
                    <c:if test="${pageId== 1 && indexEnd ==1}">
                        <li><a >&lt;</a></li>
                        <c:forEach begin="1" end="${indexEnd}" var= "i">
                            <li id="${i}" ><a  href="${pageContext.request.contextPath}/admin/user/list-controller?index=${i}&txtSearch=${txtSearch}&sortBy=${sortBy}&order=${order}">${i}</a></li>
                        </c:forEach>
                        <li><a >></a></li>
                    </c:if>
                    ...
                    <c:if test="${ indexEnd !=1}">
                        ...
                        <c:if test="${pageId ==1}" >
                            ...
                            <li><a href="${pageContext.request.contextPath}/admin/user/list-controller?index=${pageId+1}&txtSearch=${txtSearch}&sortBy=${sortBy}&order=${order}">&gt;</a></li>
                        </c:if>
