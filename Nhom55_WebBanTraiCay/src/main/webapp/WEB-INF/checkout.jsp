                    ...
                    <div class="row align-items-end">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="ten_nguoi-dung" style="color: black !important;" id="firstname" type="text" class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="lastname">Họ</label>
                                <input name="ho_nguoi-dung" style="color: black !important;" id="lastname" type="text" class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="w-100"></div>
                        <div class="w-100"></div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="dia-chi_nguoi-dung" style="color: black !important;" id="street-address" type="text" class="form-control" placeholder="Tên đường và số nhà">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="can-ho_nguoi-dung" style="color: black !important;"  type="text" class="form-control"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="tp_nguoi-dung" style="color: black !important;" id="town-city" type="text" class="form-control" onchange="handleSelectChange()">
                                    <option style="display: none" value="">Vui lòng chọn thành phố</option>
                                    <option style="color: black" value="Dĩ An">Dĩ An</option>
                                    <option style="color: black" value="Thành Phố Hồ Chí Minh">Thành Phố Hồ Chí Minh</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="sdt_nguoi-dung" style="color: black !important;" id="phone" type="text" class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="emailaddress">Email Address</label>
                                <input name="email_nguoi-dung" style="color: black !important;" id="emailaddress" type="text" class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5 pt-3">
                        <div class="col-md-12 d-flex mb-5">
                            <div class="cart-detail cart-total p-3 p-md-4">
                                ...
                                <p class="d-flex">
                                    <span>Tổng phụ</span>
                                    <span class="tong_phu">200.000đ</span>
                                </p>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="radio">
                                            ...
                                            <input type="text" id="cardNumberInput" placeholder="Số thẻ">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="radio">
                                            ...
                                            <input type="text" id="cardCVCInput" placeholder="Thẻ CVC">
                                        </div>
                                    </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    ...
                    Mọi quyền được bảo lưu | Mẫu này được thực hiện <i class="icon-heart color-danger"
  ...
  function handleSelectChange() {
    ...
    switch (selectedValue) {
      case "Dĩ An":
        ...
        var phiVanChuyen = parseInt(document.querySelector('.phi_van_chuyen').innerText.replace(/[.,đ]/g,''))
