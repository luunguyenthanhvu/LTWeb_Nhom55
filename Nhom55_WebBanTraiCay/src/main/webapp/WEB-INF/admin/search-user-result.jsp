...
<%--                    Trường hợp tìm ra số sản phẩm chỉ có trong 1 trang thì 2 nút <,> ko được xài&ndash;%&gt;--%>
                    <c:if test="${pageId== 1 && indexEnd ==1}">
                        ...
                        <c:forEach begin="1" end="${indexEnd}" var= "i">
                            <li id="${i}" ><a  href="listController?index=${i}&txtSearch=${txtSearch}&sortBy=${sortBy}&order=${order}">${i}</a></li>
                        </c:forEach>
                        <li><a >></a></li>
                    </c:if>
                    ...
                    <c:if test="${ indexEnd !=1}">
                        ...
                        <c:if test="${pageId ==1}" >
                            ...
                            <li><a href="listController?index=${pageId+1}&txtSearch=${txtSearch}&sortBy=${sortBy}&order=${order}">&gt;</a></li>
                        </c:if>
