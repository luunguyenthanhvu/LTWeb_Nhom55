    ...
    <div class="container-child-right">
      ...
      <div class="user-profile" style="margin-right: 50px">
        <div class="user-basic-info">
          <table style="border-collapse:collapse;
            ...
            <tr>
              ...
              <td><span style="position: relative; top: -5px; margin-left: 80px" id="email_nd" type="text">${user.getEmail()}</span></td>
            </tr>
            <td><br></td>
        ...
        <div class="anhNguoiDung">
          <img class="anhCuaNguoiDung" src="static/images/saber.jpg" alt="">
        </div>
      </div>
