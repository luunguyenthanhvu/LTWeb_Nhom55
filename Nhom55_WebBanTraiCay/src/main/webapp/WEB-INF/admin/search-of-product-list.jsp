            ...
            <div class="pagination">
                ...
                <c:if test="${pageId== 1 && indexEnd ==1}">
                    ...
                    <c:forEach begin="1" end="${indexEnd}" var= "i">
                        <a id="${i}" href="ProductListController?index=${i}&txtSearch=${txtSearch}">${i}</a>
                    </c:forEach>
                    <a >&raquo;</a>
                </c:if>
                <c:if test="${ indexEnd !=1}">
                    ...
                    <c:if test="${pageId ==1}" >
                        ...
                        <a href="ProductListController?index=${pageId+1}&txtSearch=${txtSearch}">&raquo;</a>
                    </c:if>
                    <%--  Còn trường hợp này nút nào cũng xài được--%>
                    <c:if test="${pageId >1 && pageId<indexEnd}" >
                        <a href="ProductListController?index=${pageId-1}&txtSearch=${txtSearch}">&laquo;</a>
                        <c:forEach begin="1" end="${indexEnd}" var= "i">
                            <a id="${i}" href="ProductListController?index=${i}&txtSearch=${txtSearch}">${i}</a>
                        </c:forEach>
                        <a href="ProductListController?index=${pageId+1}&txtSearch=${txtSearch}">&raquo;</a>
