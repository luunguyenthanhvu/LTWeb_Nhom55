...
<div style="display:none;" id="myDiv" class="animate-bottom">
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">Chỉnh sửa nhà cung cấp</span>
    </div>
    <div class="container">
      <!--       code thêm ở đây-->
      <div class="form-sp">
        ...
        >
          <table style="border-collapse:collapse;
            ...
            <tr>
              ...
              <td><input name="id_san_pham" style="width: 300px" id="id_sp" type="text" value="${provider.getId()}" disabled></td>
              <td><input type="hidden" name="id_san_pham" value="${provider.getId()}"></td>
            </tr>
            <td><br></td>
            <tr>
              ...
              <td><input name="ten_nha_cung_cap" style="width: 300px" id="ten_nhacungcap"
                         type="text" value="${provider.getProviderName()}"></td>
            </tr>
            <td><br></td>
            ...
            <tr>
              ...
              <td><textarea cols="44" rows="7" id="diachi_nhacungcap"
                            name="dia_chi_nha_cung_cap">${provider.getAddressOfProvider()}</textarea></td>
